...
class EditShippingAddressPage(BasePage):
    shipping_and_billing_address_locator = Locator(by=By.LINK_TEXT, value="shipping and billing addresses")
    edit_shipping_address_locator = Locator(by=By.LINK_TEXT, value="Edit Billing address")
    ...
    def click_on_shipping_and_billing_address_link(self):
        self.wait_and_click(self.shipping_and_billing_address_locator, timeout=10)

    def click_on_edit_shipping_address_link(self):
        self.wait_and_click(self.edit_shipping_address_locator, timeout=10)
    ...
    def clear_street_address(self):
        ...
        self.clear(self.address_street_input_locator)
